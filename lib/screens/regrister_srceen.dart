...
class _RegisterPageViewScreenState extends State<RegisterPageViewScreen> {
  ...
  final unitKerjaController = TextEditingController();
  ...
  void _submitRegister() {
    setState(() {
      isSubmitted = true;
      isApproved = false; // Status awal adalah Pending Verification
    });
    _nextPage();
  }

  void _checkApprovalStatus() {
    // Simulasi API call untuk memeriksa status registrasi
    Future.delayed(Duration(seconds: 5), () {
      setState(() {
        isApproved = true; // Ubah status menjadi disetujui
      });
    });
  }
        ...
        children: [
          ...
          Expanded(
            child: PageView(
              ...
              physics: NeverScrollableScrollPhysics(), // Agar tidak bisa swipe manual
              children: [
                _buildStep1Form(),
                _buildStep2Terms(),
