...
class LaporanPinjamanPage extends StatelessWidget {
  const LaporanPinjamanPage({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              const Icon(Icons.monetization_on, size: 24, color: Colors.black),
              const SizedBox(width: 12),
              Text(
                'Jumlah Pinjaman : Rp ${jumlahPinjaman.toString()}',
          ...
          Row(
            children: [
              const Icon(Icons.assignment_turned_in, size: 24, color: Colors.black),
              const SizedBox(width: 12),
              Text(
                'Status : $status',
                style: const TextStyle(color: Colors.black54),
