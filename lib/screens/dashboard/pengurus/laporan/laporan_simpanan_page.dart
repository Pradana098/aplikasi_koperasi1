...
class LaporanSimpananPage extends StatelessWidget {
  const LaporanSimpananPage({super.key});
  ...
  Widget _buildSimpananCard({
    ...
    required int simpananPokok,
    required int simpananWajib,
  }) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Simpanan Pokok : Rp ${simpananPokok.toString()}',
            style: const TextStyle(color: Colors.black54),
          ),
          Text(
            'Simpanan Wajib : Rp ${simpananWajib.toString()}',
            style: const TextStyle(color: Colors.black54),
          ),
        ],
      ),
